...
ICM20948_UT_PER_LSB = 0.15  # DS MAGNETOMETER SPECIFICATIONS, header file
...
path = r"data/user_desk/magn_red_test_15_06_2021.csv"
...
# CENTER AND RADII CALCULATIONS:
# calc:
mx_offset = (max(mx)+min(mx))/2.0
a = ((max(mx)-min(mx))/2.0)
# print:
print("mx offset: ")
print(mx_offset)
...
magn_offset = [mx_offset, my_offset, mz_offset]
